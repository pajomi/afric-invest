...
class Auth extends CI_Controller {
	...
	function __construct()
	{
		...
		// Von Patrick hinzugefügt
		//$this->load->library('email');
		//$this->email->from('info@tank-mops.de','info');
		// Von Patrick
	...
	function login()
	{
		...
		if ($this->form_validation->run() == true)
		{
			...
			if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember))
			{
				...
				// alternative-Code: Capture the user
				$user     = $this->ion_auth->user()->row();
				$username = $this->ion_auth->user()->row()->username;
				$group     = $this->ion_auth->get_users_groups()->row();
				$groupname = $this->ion_auth->get_users_groups()->row()->name;
				redirect($groupname);
	...
	// Hinzugefügt von Patrick Michel
	//edit yourself
	function edit_self($id)
	{
		...
		$this->_render_page('auth/edit_self', $this->data);
	}
	...
	{
		$this->data['title'] = "Datenschutz";
		$this->_render_page('auth/datenschutz', $this->data);
	}

	function impressum()
	{
		$this->data['title'] = "Impressum";
		$this->_render_page('auth/impressum', $this->data);
	}
}
